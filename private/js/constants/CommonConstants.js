...
angular.module('ProjMngmnt')
    .constant('CommonConstants', {
        ...
        PROJECT_LEVEL_ARTIFACTS: [ "action", "risk", "pendingIssue", "changeRequest", "resource", "document", "milestone", "todo", "humanResource", "communicationPlan", "writeup", "reunionPlanning" ],
